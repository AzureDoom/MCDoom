 ...
 * */
public class DoomNavigation extends GroundPathNavigation {

	public DoomNavigation(Mob entity, Level world) {
		super(entity, world);
	}
	...
	protected PathFinder createPathFinder(int maxVisitedNodes) {
		...
		return new DoomPathFinder(this.nodeEvaluator, maxVisitedNodes);
	}
