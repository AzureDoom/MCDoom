...
public class FlyingRangeAttackGoal extends Goal {
	...
	public void tick() {
		...
		if (livingEntity != null) {
			boolean bl = this.actor.getSensing().canSee(livingEntity);
	...
	public void shootFireball(LivingEntity livingentity) {
		World world = this.actor.level;
		Vector3d vec3d = this.actor.getViewVector(1.0F);
		...
		actor.level.playSound(null, actor, sound, SoundCategory.HOSTILE, 0.5F, 1.0F);
