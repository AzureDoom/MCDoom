...
public class NightmareImpEntity extends DemonEntity implements IAnimatable, IAnimationTickable {
		...
		this.goalSelector.addGoal(4,
				new RangedStrafeAttackGoal(this,
						new FireballAttack(this, false).setProjectileOriginOffset(0.8, 0.8, 0.8)
								.setDamage(config.nightmare_ranged_damage.get().floatValue())
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 25.0D)
				.add(Attributes.MAX_HEALTH, config.nightmare_imp_health.get()).add(Attributes.ATTACK_DAMAGE, 0.0D)
