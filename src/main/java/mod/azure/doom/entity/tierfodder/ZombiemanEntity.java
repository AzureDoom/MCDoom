...
public class ZombiemanEntity extends DemonEntity implements IAnimatable, IAnimationTickable {
		...
		this.goalSelector.addGoal(4,
				new RangedAttackGoal(this,
						new RangedAttack(this).setProjectileOriginOffset(0.8, 0.4, 0.8)
								.setDamage(DoomConfig.SERVER.bullet_damage.get().floatValue())
								.setSound(ModSoundEvents.PISTOL_HIT.get(), 1.0F, 1.0F),
						1.1D));
	...
	public class RangedAttack extends AbstractRangedAttack {
		...
		public AttackSound getDefaultAttackSound() {
			return new AttackSound(ModSoundEvents.PISTOL_HIT.get(), 1, 1);
		}
