...
public class ZombiemanEntity extends DemonEntity implements RangedAttackMob, IAnimatable {
	...
	public static boolean spawning(EntityType<ZombiemanEntity> p_223337_0_, LevelAccessor p_223337_1_, MobSpawnType reason,
	...
	public void setCombatTask() {
		if (this.level != null && !this.level.isClientSide) {
			...
			ItemStack itemstack = this.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, DoomItems.PISTOL.get()));
