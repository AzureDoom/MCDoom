...
public class GargoyleEntity extends DemonEntity implements GeoEntity {
		...
		this.goalSelector.addGoal(4,
				new RangedAttackGoal(this,
						new FireballAttack(this, false).setProjectileOriginOffset(0.8, 0.8, 0.8)
								.setDamage(DoomConfig.gargoyle_ranged_damage).setSound(SoundEvents.BLAZE_SHOOT, 1.0F,
	...
	public static AttributeSupplier.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D)
				.add(Attributes.MAX_HEALTH, DoomConfig.gargoyle_health).add(Attributes.ATTACK_DAMAGE, 0.0D)
