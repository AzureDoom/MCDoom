...
public class ShotgunguyEntity extends DemonEntity implements RangedAttackMob, IAnimatable {
	...
	public static boolean spawning(EntityType<ShotgunguyEntity> p_223337_0_, LevelAccessor p_223337_1_, MobSpawnType reason,
	...
	public void setCombatTask() {
		if (this.level != null && !this.level.isClientSide) {
			...
			ItemStack itemstack = this.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, DoomItems.SG.get()));
	...
	public void performRangedAttack(LivingEntity target, float distanceFactor) {
		ItemStack itemstack = this
				.getProjectile(this.getItemInHand(ProjectileUtil.getWeaponHoldingHand(this, DoomItems.SG.get())));
