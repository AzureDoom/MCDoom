...
public class MechaZombieEntity extends DemonEntity implements IAnimatable {
		...
		this.goalSelector.addGoal(4,
				new RangedStrafeAttackGoal(this,
						new FireballAttack(this, false).setProjectileOriginOffset(0.8, 0.8, 0.8)
								.setDamage(DoomConfig.SERVER.mechazombie_ranged_damage.get().floatValue()).setSound(SoundEvents.BLAZE_SHOOT,
	...
	public static AttributeSupplier.Builder createAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 25.0D)
				.add(Attributes.MAX_HEALTH, DoomConfig.SERVER.mechazombie_health.get())
				.add(Attributes.ATTACK_DAMAGE, DoomConfig.SERVER.mechazombie_melee_damage.get())
