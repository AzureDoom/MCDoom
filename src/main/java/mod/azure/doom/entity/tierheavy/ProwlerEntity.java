...
public class ProwlerEntity extends DemonEntity implements GeoEntity {
		...
		this.goalSelector.addGoal(4,
				new ProwlerEntity.RangedStrafeAttackGoal(this,
						new FireballAttack(this, false).setProjectileOriginOffset(0.4, 0.4, 0.4)
								.setDamage(DoomConfig.prowler_ranged_damage).setSound(SoundEvents.BLAZE_SHOOT, 1.0F,
	...
	public static AttributeSupplier.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D)
				.add(Attributes.MAX_HEALTH, DoomConfig.prowler_health).add(Attributes.KNOCKBACK_RESISTANCE, 0.6f)
				.add(Attributes.ATTACK_DAMAGE, DoomConfig.prowler_melee_damage).add(Attributes.MOVEMENT_SPEED, 0.25D)
