...
public class CacodemonEntity extends DemonEntity implements Enemy, GeoEntity {
	...
	public static AttributeSupplier.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D)
				.add(Attributes.FLYING_SPEED, 0.25D).add(Attributes.MAX_HEALTH, DoomConfig.cacodemon_health)
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RangedStaticAttackGoal(this,
				new FireballAttack(this, true).setDamage(DoomConfig.cacodemon_ranged_damage)
						.setProjectileOriginOffset(1.5, 0.3, 1.5).setSound(DoomSounds.CACODEMON_AFFECTIONATE_SCREAM,
