...
public class CacodemonEntity extends DemonEntity implements IMob, IAnimatable, IAnimationTickable {
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 25.0D)
				.add(Attributes.FLYING_SPEED, 0.25D).add(Attributes.MAX_HEALTH, config.cacodemon_health.get())
