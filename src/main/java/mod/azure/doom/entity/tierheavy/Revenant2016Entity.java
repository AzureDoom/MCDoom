		...
		controllers.add(new AnimationController<>(this, "livingController", 0, event -> {
			...
			if (event.getKeyframeData().getSound().matches("attack"))
				if (level().isClientSide())
					level().playLocalSound(this.getX(), this.getY(), this.getZ(), this.getVariant() == 11 ? DoomSounds.REVENANT_DOOT : DoomSounds.ROCKET_FIRING, SoundSource.HOSTILE, 0.25F, 1.0F, false);
