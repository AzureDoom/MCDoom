...
public class PainEntity extends DemonEntity implements Monster, IAnimatable, IAnimationTickable {
	...
	public PainEntity(EntityType<? extends PainEntity> type, World worldIn) {
		super(type, worldIn);
		this.moveControl = new PainEntity.MoveController(this);
	}
	...
	static class MoveController extends MoveControl {
		...
		public MoveController(PainEntity ghast) {
			super(ghast);
			this.ghast = ghast;
		}
	...
	public static DefaultAttributeContainer.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(EntityAttributes.GENERIC_FOLLOW_RANGE, 25.0D)
				.add(EntityAttributes.GENERIC_FLYING_SPEED, 0.25D).add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.25D)
