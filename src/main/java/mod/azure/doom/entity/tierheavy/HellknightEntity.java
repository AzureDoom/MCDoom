...
public class HellknightEntity extends DemonEntity implements GeoEntity {
	...
	protected void applyEntityAI() {
		goalSelector.addGoal(4, new RangedStrafeAttackGoal(this, new HellknightEntity.FireballAttack(this).setProjectileOriginOffset(0.8, 0.4, 0.8).setDamage(DoomConfig.hellknight_ranged_damage), 1.1, 1));
