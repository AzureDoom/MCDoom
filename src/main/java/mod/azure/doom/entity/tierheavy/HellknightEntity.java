...
public class HellknightEntity extends DemonEntity implements GeoEntity {

	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public static final TrackedData<Integer> VARIANT = DataTracker.registerData(HellknightEntity.class,
	...
	protected void initGoals() {
		...
		this.goalSelector.add(4, new RangedStrafeAttackGoal(this, new HellknightEntity.FireballAttack(this)
				.setProjectileOriginOffset(0.8, 0.8, 0.8).setDamage(DoomConfig.hellknight_ranged_damage), 1.1, 1));
	...
	public static DefaultAttributeContainer.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(EntityAttributes.GENERIC_FOLLOW_RANGE, 40.0D)
				...
				.add(EntityAttributes.GENERIC_MAX_HEALTH, DoomConfig.hellknight_health)
				.add(EntityAttributes.GENERIC_ATTACK_DAMAGE, DoomConfig.hellknight_melee_damage)
