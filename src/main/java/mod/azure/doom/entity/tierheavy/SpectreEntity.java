...
public class SpectreEntity extends DemonEntity implements GeoEntity {
	...
	public static AttributeSupplier.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D)
				.add(Attributes.KNOCKBACK_RESISTANCE, 0.6f).add(Attributes.MAX_HEALTH, DoomConfig.spectre_health)
				.add(Attributes.ATTACK_DAMAGE, DoomConfig.spectre_melee_damage).add(Attributes.MOVEMENT_SPEED, 0.25D)
