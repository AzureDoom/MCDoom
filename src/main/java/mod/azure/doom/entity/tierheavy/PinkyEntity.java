...
public class PinkyEntity extends DemonEntity implements GeoEntity {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(4, new DemonAttackGoal(this, 1.75D, 2));
	...
	public static AttributeSupplier.Builder createMobAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 40.0D).add(Attributes.KNOCKBACK_RESISTANCE, 0.6f).add(Attributes.MAX_HEALTH, DoomConfig.pinky_health).add(Attributes.ATTACK_DAMAGE, DoomConfig.pinky_melee_damage).add(Attributes.MOVEMENT_SPEED, 0.25D).add(Attributes.ATTACK_KNOCKBACK, 10.0D);
	}
