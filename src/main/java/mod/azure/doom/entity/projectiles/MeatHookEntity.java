...
public class MeatHookEntity extends AbstractArrow implements GeoEntity {
	...
	public MeatHookEntity(Level world, LivingEntity owner) {
		super(DoomProjectiles.MEATHOOOK_ENTITY.get(), owner, world);
		setNoGravity(true);
		setBaseDamage(0);
	}

	public MeatHookEntity(Level world, double x, double y, double z) {
		super(DoomProjectiles.MEATHOOOK_ENTITY.get(), x, y, z, world);
		setNoGravity(true);
		setBaseDamage(0);
	}

	public MeatHookEntity(Level world) {
		super(DoomProjectiles.MEATHOOOK_ENTITY.get(), world);
		setNoGravity(true);
		setBaseDamage(0);
	}
