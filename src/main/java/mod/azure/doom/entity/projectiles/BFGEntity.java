...
public class BFGEntity extends AbstractArrow implements GeoEntity {
    ...
    List<? extends String> whitelistEntries = List.of(DoomMod.config.bfg_damage_mob_whitelist);
    ...
    public BFGEntity(Level world, LivingEntity owner) {
        super(DoomProjectiles.BFG_CELL.get(), owner, world);
        this.shooter = owner;
    }
    ...
    public void tick() {
        ...
        this.getCommandSenderWorld().getEntities(this, aabb).forEach(e -> {
            ...
            if (!(e instanceof Player || e instanceof EnderDragon || e instanceof GoreNestEntity || e instanceof IconofsinEntity || e instanceof ArchMakyrEntity || e instanceof GladiatorEntity || e instanceof MotherDemonEntity) && (e instanceof Monster || e instanceof Slime || e instanceof Phantom || e instanceof DemonEntity || e instanceof Shulker || e instanceof Hoglin || (e == listEntity))) {
                if (e.isAlive()) {
                    e.hurt(damageSources().explosion(this, shooter), DoomMod.config.bfgball_damage_aoe);
                    this.setTargetedEntity(e.getId());
                }
            }
            if (e instanceof EnderDragon) {
                if (e.isAlive()) {
                    ((EnderDragon) e).head.hurt(damageSources().playerAttack((Player) this.shooter), DoomMod.config.bfgball_damage_dragon * 0.3F);
                    this.setTargetedEntity(e.getId());
                }
            }
            if (e instanceof IconofsinEntity || e instanceof ArchMakyrEntity || e instanceof GladiatorEntity || e instanceof MotherDemonEntity) {
                if (e.isAlive()) {
                    e.hurt(damageSources().playerAttack((Player) this.shooter), DoomMod.config.bfgball_damage_aoe * 0.1F);
                }
            }
        });
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        if (!this.level().isClientSide) {
            this.doDamage();
            this.level().explode(this, this.getX(), this.getY(0.0625D), this.getZ(), 1.0F, DoomMod.config.enable_block_breaking ? Level.ExplosionInteraction.BLOCK : Level.ExplosionInteraction.NONE);
    ...
    public void doDamage() {
        ...
        this.getCommandSenderWorld().getEntities(this, aabb).forEach(e -> {
            var listEntity = randomElement.tryCast(e);
            if (!(e instanceof Player || e instanceof EnderDragon || e instanceof GoreNestEntity || e instanceof IconofsinEntity || e instanceof ArchMakyrEntity || e instanceof GladiatorEntity || e instanceof MotherDemonEntity) && (e instanceof Monster || e instanceof Slime || e instanceof Phantom || e instanceof DemonEntity || e instanceof Shulker || e instanceof Hoglin || (e == listEntity))) {
                e.hurt(damageSources().playerAttack((Player) this.shooter), DoomMod.config.bfgball_damage);
                this.setTargetedEntity(e.getId());
                if (!this.level().isClientSide) {
            ...
            if (e instanceof IconofsinEntity || e instanceof ArchMakyrEntity || e instanceof GladiatorEntity || e instanceof MotherDemonEntity)
                if (e.isAlive())
                    e.hurt(damageSources().playerAttack((Player) this.shooter), DoomMod.config.bfgball_damage * 0.1F);
        });
    }
