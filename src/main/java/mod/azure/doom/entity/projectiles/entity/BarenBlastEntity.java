...
public class BarenBlastEntity extends AbstractHurtingProjectile implements GeoEntity {
	...
	public BarenBlastEntity(Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
		...
		super(ProjectilesEntityRegister.BARENBLAST.get(), shooter, accelX, accelY, accelZ, worldIn);
		this.shooter = shooter;
		this.directHitDamage = directHitDamage;
	}

	public BarenBlastEntity(Level worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(ProjectilesEntityRegister.BARENBLAST.get(), x, y, z, accelX, accelY, accelZ, worldIn);
	}
