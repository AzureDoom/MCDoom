...
public class BarenBlastEntity extends AbstractHurtingProjectile implements IAnimatable {
	...
	public BarenBlastEntity(Level worldIn, LivingEntity shooter, double accelX, double accelY, double accelZ,
		...
		super(DoomEntities.BARENBLAST.get(), shooter, accelX, accelY, accelZ, worldIn);
