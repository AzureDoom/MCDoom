...
public class BaronEntity extends DemonEntity implements GeoEntity {
	...
	protected void registerGoals() {
		...
		goalSelector.addGoal(4, new RangedStrafeAttackGoal(this, new BaronEntity.FireballAttack(this).setProjectileOriginOffset(0.8, 0.4, 0.8).setDamage(DoomConfig.baron_ranged_damage), 1.2, 2));
