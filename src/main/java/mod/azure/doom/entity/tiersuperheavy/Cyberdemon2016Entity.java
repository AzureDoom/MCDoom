...
public class Cyberdemon2016Entity extends DemonEntity implements IAnimatable {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4,
				new RangedStaticAttackGoal(this, new Cyberdemon2016Entity.FireballAttack(this)
						.setProjectileOriginOffset(0.8, 0.8, 0.8).setDamage(config.cyberdemon2016_ranged_damage.get()),
						60, 20, 30F, 1));
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		return LivingEntity.createLivingAttributes().add(Attributes.FOLLOW_RANGE, 25.0D)
				.add(Attributes.MAX_HEALTH, config.cyberdemon2016_health.get()).add(Attributes.ATTACK_DAMAGE, 0.0D)
