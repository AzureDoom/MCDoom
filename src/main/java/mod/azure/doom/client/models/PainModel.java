...
public class PainModel extends GeoModel<PainEntity> {
	...
	public ResourceLocation getModelResource(PainEntity object) {
		return new ResourceLocation(DoomMod.MODID, "geo/" + (object.getVariant() == 2 ? "pain64" : object.getVariant() == 3 ? "paineternal" : "pain") + ".geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(PainEntity object) {
		return new ResourceLocation(DoomMod.MODID, "textures/entity/" + (object.getVariant() == 2 ? object.getAttckingState() == 2 ? "painelemental64-attacking" : "painelemental64-normal" : object.getVariant() == 3 ? "paineternal" : object.getAttckingState() == 1 ? "painelemental-attacking" : "painelemental-normal") + ".png");
	}

	@Override
	public ResourceLocation getAnimationResource(PainEntity object) {
		return new ResourceLocation(DoomMod.MODID, "animations/" + (object.getVariant() == 3 ? "paineternal." : "pain_") + "animation.json");
	}
	...
	public void setCustomAnimations(PainEntity animatable, long instanceId, AnimationState<PainEntity> animationState) {
		...
		final CoreGeoBone head = getAnimationProcessor().getBone("body");
