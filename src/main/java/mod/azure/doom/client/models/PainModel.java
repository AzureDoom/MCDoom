...
public class PainModel extends GeoModel<PainEntity> {
	...
	public ResourceLocation getTextureResource(PainEntity object) {
		return DoomMod.modResource("textures/entity/" + (object.getVariant() == 2 ? (object.getAttckingState() == 2 ? "painelemental64-attacking" : "painelemental64-normal") : object.getVariant() == 3 ? "paineternal" : (object.getAttckingState() == 1 ? "painelemental-attacking" : "painelemental-normal")) + ".png");
	}
