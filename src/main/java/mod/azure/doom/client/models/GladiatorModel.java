...
public class GladiatorModel extends GeoModel<GladiatorEntity> {
	...
	public ResourceLocation getModelResource(GladiatorEntity object) {
		return DoomMod.modResource("geo/gladiator.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(GladiatorEntity object) {
		return DoomMod.modResource("textures/entity/" + (object.getTextureState() == 1 ? "gladiator_1" : object.getTextureState() == 2 ? "gladiator_2" : "gladiator") + ".png");
	}

	@Override
	public ResourceLocation getAnimationResource(GladiatorEntity object) {
		return DoomMod.modResource("animations/gladiator.animation.json");
	}
