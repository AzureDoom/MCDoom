...
public class SpectreModel extends GeoModel<SpectreEntity> {
	...
	public ResourceLocation getModelResource(SpectreEntity object) {
		return DoomMod.modResource("geo/" + (object.getVariant() > 1 ? "pinky" : "pinky2016") + ".geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(SpectreEntity object) {
		return DoomMod.modResource("textures/entity/" + (object.getVariant() == 2 ? "pinky-texturemap" : object.getVariant() == 3 ? "pinky_green" : "pinky2016") + ".png");
	}
