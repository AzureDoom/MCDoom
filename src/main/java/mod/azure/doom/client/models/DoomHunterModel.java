...
public class DoomHunterModel extends GeoModel<DoomHunterEntity> {
	...
	private static final ResourceLocation[] TEX = { new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_1.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_2.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_3.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_4.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_5.png"),
			new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_6.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/doomhunter_7.png") };
