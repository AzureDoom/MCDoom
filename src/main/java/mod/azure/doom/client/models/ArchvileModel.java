...
public class ArchvileModel extends GeoModel<ArchvileEntity> {
	...
	private static final ResourceLocation[] TEX = { new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_1.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_2.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_3.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_4.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_5.png"),
			new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_6.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_7.png"), new ResourceLocation(DoomMod.MODID, "textures/entity/archvile_flame_8.png") };
	...
	public ResourceLocation getTextureResource(ArchvileEntity object) {
		return object.getVariant() == 1 ? object.getAttckingState() == 1 ? TEX[object.getFlameTimer()] : new ResourceLocation(DoomMod.MODID, "textures/entity/archvile.png") : new ResourceLocation(DoomMod.MODID, "textures/entity/archvileeternal.png");
	}
