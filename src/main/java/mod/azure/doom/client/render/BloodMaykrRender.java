...
public class BloodMaykrRender extends GeoEntityRenderer<BloodMaykrEntity> {
	...
	public BloodMaykrRender(EntityRendererManager renderManagerIn) {
		super(renderManagerIn, new BloodMaykrModel());
	}

	@Override
	public RenderType getRenderType(BloodMaykrEntity animatable, float partialTicks, MatrixStack stack,
