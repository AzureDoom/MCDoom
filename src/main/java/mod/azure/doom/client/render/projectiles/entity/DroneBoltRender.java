...
public class DroneBoltRender extends EntityRenderer<DroneBoltEntity> {
	...
	public DroneBoltRender(EntityRendererManager renderManagerIn) {
	...
	@Override
	public void render(DroneBoltEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
