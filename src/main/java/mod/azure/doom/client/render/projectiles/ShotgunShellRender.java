...
public class ShotgunShellRender extends GeoEntityRenderer<ShotgunShellEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ShotgunShellEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
