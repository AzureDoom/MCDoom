...
public class ShotgunShellRender extends GeoProjectilesRenderer<ShotgunShellEntity> {
	...
	@Override
	public RenderType getRenderType(ShotgunShellEntity animatable, float partialTicks, PoseStack stack,
	...
	@Override
	public void renderEarly(ShotgunShellEntity animatable, PoseStack stackIn, float ticks,
