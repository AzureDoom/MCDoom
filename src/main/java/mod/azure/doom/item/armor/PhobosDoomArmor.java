...
public class PhobosDoomArmor extends ArmorItem implements IAnimatable {
	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(
				Text.translatable("doom.phobosarmor.text").formatted(Formatting.YELLOW).formatted(Formatting.ITALIC));
