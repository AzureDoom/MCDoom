...
public class DarkLordArmor extends GeoArmorItem implements IAnimatable {
	...
	public DarkLordArmor(IArmorMaterial materialIn, EquipmentSlotType slot) {
	...
	public void appendHoverText(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new TranslationTextComponent("doom.darklordarmor.text").withStyle(TextFormatting.YELLOW)
