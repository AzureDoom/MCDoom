...
public class ShellAmmo extends Item {
  ...
  public void appendHoverText(ItemStack stack, Level worldIn,
    ...
    tooltip.add(new TranslatableComponent("doom.shell.text")
                    .withStyle(ChatFormatting.ITALIC));
    super.appendHoverText(stack, worldIn, tooltip, flagIn);
  }

  public ShotgunShellEntity createArrow(Level world, ItemStack stack,
                                        LivingEntity shooter,
                                        boolean marauder) {
    ShotgunShellEntity arrowentity = new ShotgunShellEntity(
        world, shooter,
