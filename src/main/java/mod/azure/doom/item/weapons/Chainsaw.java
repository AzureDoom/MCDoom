...
public class Chainsaw extends Item {
    ...
    public void inventoryTick(ItemStack stack, Level worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (worldIn.isClientSide && entityIn instanceof Player player2 && player2.getMainHandItem().getItem() instanceof Chainsaw)
            if (Keybindings.RELOAD.isDown() && isSelected && !player.getCooldowns().isOnCooldown(stack.getItem()))
