...
public class SwordCrucibleItem extends SwordItem implements GeoItem {
	...
	public SwordCrucibleItem() {
		super(DoomTier.DOOM_HIGHTEIR, 1, -2.5f, new Item.Properties().stacksTo(1).durability(DoomMod.config.crucible_max_uses));
	...
	public void inventoryTick(ItemStack stack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (world.isClientSide())
			if (playerentity.getMainHandItem().getItem() instanceof SwordCrucibleItem && Keybindings.RELOAD.consumeClick() && selected) {
