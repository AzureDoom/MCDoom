...
public class SentinelHammerItem extends SwordItem implements GeoItem {
	...
	public SentinelHammerItem() {
		super(DoomTier.DOOM_HIGHTEIR, 1, -2.5f, new Item.Properties().stacksTo(1).durability(DoomMod.config.sentinelhammer_max_uses));
	...
	public void inventoryTick(ItemStack stack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (world.isClientSide) 
			if (playerentity.getMainHandItem().getItem() instanceof SentinelHammerItem && Keybindings.RELOAD.consumeClick() && selected) {
