...
public class MobSpawn {
	...
	public static void addSpawnEntries() {
		...
		BiomeModifications.addSpawn(
				...
				SpawnGroup.MONSTER, DoomEntities.SPECTRE, DoomConfig.spectre_spawn_weight,
		...
		BiomeModifications.addSpawn(
				...
				SpawnGroup.MONSTER, DoomEntities.CUEBALL, DoomConfig.cueball_spawn_weight,
		...
		BiomeModifications.addSpawn(
				...
				SpawnGroup.MONSTER, DoomEntities.PROWLER, DoomConfig.prowler_spawn_weight,
		...
		BiomeModifications.addSpawn(
				BiomeSelectors.all().and(context -> parseBiomes(DoomConfig.turret_biomes, context)),
				SpawnGroup.MONSTER, DoomEntities.TURRET, DoomConfig.turret_spawn_weight,
				DoomConfig.turret_min_group, DoomConfig.turret_max_group);
