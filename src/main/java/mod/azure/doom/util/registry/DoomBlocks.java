...
public class DoomBlocks {
	...
	public static final RegistryObject<Block> TOTEM = BLOCKS.register("totem",
			() -> new TotemBlock(
					(BlockBehaviour.Properties.of(Material.METAL).strength(4.0f).sound(SoundType.BONE_BLOCK)
	...
	public static final RegistryObject<Block> GUN_TABLE = BLOCKS.register("gun_table", () -> new GunTableBlock(
			(BlockBehaviour.Properties.of(Material.METAL).strength(4.0f).sound(SoundType.METAL).noOcclusion())));
	...
	public static final RegistryObject<Block> ARGENT_BLOCK = BLOCKS.register("argent_block", () -> new ArgentBlock(
			(BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(4.0F).sound(SoundType.METAL))));

	public static final RegistryObject<Block> ARGENT_LAMP_BLOCK = BLOCKS.register("argent_lamp_block",
			() -> new ArgentLampBlock(
					(BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(4.0F).sound(SoundType.BONE_BLOCK))));
	...
	public static final RegistryObject<Block> E1M1_1 = BLOCKS.register("e1m1_block1",
			() -> new ArgentLampBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(4.0F))));
	...
	public static final RegistryObject<Block> E1M1_9 = BLOCKS.register("e1m1_block9",
			() -> new E1M1TurnableBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(4.0F))));
	...
	public static final RegistryObject<Block> E1M1_11 = BLOCKS.register("e1m1_block11",
			() -> new E1M1TurnableHurtBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).strength(4.0F))));
