...
public class DoomBlocks {
	...
	public static final RegistryObject<Block> ARGENT_BLOCK = BLOCKS.register("argent_block", () -> new ArgentBlock(
			(BlockBehaviour.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F).sound(SoundType.METAL))));

	public static final RegistryObject<Block> ARGENT_LAMP_BLOCK = BLOCKS.register("argent_lamp_block",
			() -> new ArgentLampBlock(
					(BlockBehaviour.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F).sound(SoundType.BONE_BLOCK))));

	public static final RegistryObject<Block> DOOM_SAND = BLOCKS.register("doom_sand",
			() -> new DoomSandBlock((Block.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F).sound(SoundType.STONE))));
	...
	public static final RegistryObject<Block> DOOM_WALL1 = BLOCKS.register("icon_wall1",
			() -> new DoomWallBlock((Block.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F).sound(SoundType.STONE))));
	...
	public static final RegistryObject<Block> E1M1_1 = BLOCKS.register("e1m1_block1",
			() -> new ArgentLampBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F))));
	...
	public static final RegistryObject<Block> E1M1_9 = BLOCKS.register("e1m1_block9",
			() -> new E1M1TurnableBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F))));
	...
	public static final RegistryObject<Block> E1M1_11 = BLOCKS.register("e1m1_block11",
			() -> new E1M1TurnableHurtBlock((BlockBehaviour.Properties.of(Material.HEAVY_METAL).explosionResistance(30).strength(4.0F))));
