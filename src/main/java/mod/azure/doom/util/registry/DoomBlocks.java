...
public class DoomBlocks {
	...
	public static void init() {
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "gun_table"),
				new DoomBlockItem(GUN_TABLE, new Item.Settings().group(DoomMod.DoomWeaponItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "totem"),
				new DoomBlockItem(TOTEM, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "argent_block"),
				new BlockItem(ARGENT_BLOCK, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "jump_pad"),
				new BlockItem(JUMP_PAD, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "doom_sand"),
				new BlockItem(DOOM_SAND, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "argent_lamp_block"),
				new BlockItem(ARGENT_LAMP_BLOCK, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "barrel"),
				new BlockItem(BARREL_BLOCK, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall1"),
				new BlockItem(ICON_WALL1, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall2"),
				new BlockItem(ICON_WALL2, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall3"),
				new BlockItem(ICON_WALL3, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall4"),
				new BlockItem(ICON_WALL4, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall5"),
				new BlockItem(ICON_WALL5, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall6"),
				new BlockItem(ICON_WALL6, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall7"),
				new BlockItem(ICON_WALL7, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall8"),
				new BlockItem(ICON_WALL8, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall9"),
				new BlockItem(ICON_WALL9, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall10"),
				new BlockItem(ICON_WALL10, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall11"),
				new BlockItem(ICON_WALL11, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall12"),
				new BlockItem(ICON_WALL12, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall13"),
				new BlockItem(ICON_WALL13, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall14"),
				new BlockItem(ICON_WALL14, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall15"),
				new BlockItem(ICON_WALL15, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "icon_wall16"),
				new BlockItem(ICON_WALL16, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block1"),
				new BlockItem(E1M1_1, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block2"),
				new BlockItem(E1M1_2, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block3"),
				new BlockItem(E1M1_3, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block4"),
				new BlockItem(E1M1_4, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block5"),
				new BlockItem(E1M1_5, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block6"),
				new BlockItem(E1M1_6, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block7"),
				new BlockItem(E1M1_7, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block8"),
				new BlockItem(E1M1_8, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block9"),
				new BlockItem(E1M1_9, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block10"),
				new BlockItem(E1M1_10, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block11"),
				new BlockItem(E1M1_11, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block12"),
				new BlockItem(E1M1_12, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block13"),
				new BlockItem(E1M1_13, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block14"),
				new BlockItem(E1M1_14, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block15"),
				new BlockItem(E1M1_15, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block16"),
				new BlockItem(E1M1_16, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block17"),
				new BlockItem(E1M1_17, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block18"),
				new BlockItem(E1M1_18, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block19"),
				new BlockItem(E1M1_19, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block20"),
				new BlockItem(E1M1_20, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block21"),
				new BlockItem(E1M1_21, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block22"),
				new BlockItem(E1M1_22, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block23"),
				new BlockItem(E1M1_23, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block24"),
				new BlockItem(E1M1_24, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block25"),
				new BlockItem(E1M1_25, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
		...
		Registry.register(Registry.ITEM, new Identifier(DoomMod.MODID, "e1m1_block26"),
				new BlockItem(E1M1_26, new Item.Settings().group(DoomMod.DoomBlockItemGroup)));
	}
}