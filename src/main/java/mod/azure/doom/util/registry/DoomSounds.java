...
public class DoomSounds {
	...
	public static final RegistryObject<SoundEvent> CACODEMON_AFFECTIONATE_SCREAM = MOD_SOUNDS.register(
			...
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DoomMod.MODID, "doom.cacodemon_affectionate_scream")));

	public static final RegistryObject<SoundEvent> SPIDERDEMON_AMBIENT = MOD_SOUNDS.register("doom.spiderdemon_step",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DoomMod.MODID, "doom.spiderdemon_step")));
