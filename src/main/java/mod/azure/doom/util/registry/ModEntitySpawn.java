...
public class ModEntitySpawn {
	...
	public static void onBiomesLoad(BiomeLoadingEvent event) {
        ...
        if (event.getName() != null ) {
            ...
            ResourceKey<Biome> biome1 = ResourceKey.create(Registry.BIOME_REGISTRY, name);
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.PROWLER, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.PROWLER.get(), config.get(EntityConfigType.PROWLER).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.IMP, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.IMP.get(), config.get(EntityConfigType.IMP).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.IMP_STONE, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.IMP_STONE.get(), config.get(EntityConfigType.IMP_STONE).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.PINKY, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.PINKY.get(), config.get(EntityConfigType.PINKY).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.SPECTRE, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.SPECTRE.get(), config.get(EntityConfigType.SPECTRE).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.LOST_SOUL, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.LOST_SOUL.get(), config.get(EntityConfigType.LOST_SOUL).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.CACODEMON, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.CACODEMON.get(), config.get(EntityConfigType.CACODEMON).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.ARCHVILE, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.ARCHVILE.get(), config.get(EntityConfigType.ARCHVILE).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.BARON, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.BARON.get(), config.get(EntityConfigType.BARON).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.MANCUBUS, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.MANCUBUS.get(), config.get(EntityConfigType.MANCUBUS).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.REVENANT, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.REVENANT.get(), config.get(EntityConfigType.REVENANT).SPAWN_WEIGHT,
					config.get(EntityConfigType.REVENANT).MIN_GROUP, config.get(EntityConfigType.REVENANT).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.REVENANT, biome)
				&& config.get(EntityConfigType.REVENANT).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.REVENANT2016.get(), config.get(EntityConfigType.REVENANT).SPAWN_WEIGHT,
					config.get(EntityConfigType.REVENANT).MIN_GROUP, config.get(EntityConfigType.REVENANT).MAX_GROUP));
		}
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.ZOMBIEMAN, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.ZOMBIEMAN.get(), config.get(EntityConfigType.ZOMBIEMAN).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.GARGOYLE, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.GARGOYLE.get(), config.get(EntityConfigType.GARGOYLE).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.IMP_2016, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.IMP2016.get(), config.get(EntityConfigType.IMP_2016).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.MECHA_ZOMBIE, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.MECHAZOMBIE.get(),
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.ARACHNOTRON, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.ARACHNOTRON.get(),
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.CHAINGUNNER, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.CHAINGUNNER.get(),
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.SHOTGUN_GUY, biome)
			...
			base.add(
					new SpawnerData(ModEntityTypes.SHOTGUNGUY.get(), config.get(EntityConfigType.SHOTGUN_GUY).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.MARAUDER, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.MARAUDER.get(), config.get(EntityConfigType.MARAUDER).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.PAIN, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.PAIN.get(), config.get(EntityConfigType.PAIN).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.HELL_KNIGHT, biome)
			...
			base.add(
					new SpawnerData(ModEntityTypes.HELLKNIGHT.get(), config.get(EntityConfigType.HELL_KNIGHT).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.CYBER_DEMON, biome)
			...
			base.add(
					new SpawnerData(ModEntityTypes.CYBERDEMON.get(), config.get(EntityConfigType.CYBER_DEMON).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.UNWILLING, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.UNWILLING.get(), config.get(EntityConfigType.UNWILLING).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.CUEBALL, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.CUEBALL.get(), config.get(EntityConfigType.CUEBALL).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.GORE_NEST, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.GORE_NEST.get(), config.get(EntityConfigType.GORE_NEST).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.TYRANT, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.TYRANT.get(), config.get(EntityConfigType.TYRANT).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.DOOMHUNTER, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.DOOMHUNTER.get(), config.get(EntityConfigType.DOOMHUNTER).SPAWN_WEIGHT,
					config.get(EntityConfigType.DOOMHUNTER).MIN_GROUP,
					config.get(EntityConfigType.DOOMHUNTER).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.ARCHVILE, biome)
				&& config.get(EntityConfigType.ARCHVILE).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.ARCHVILEETERNAL.get(),
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.PINKY, biome)
				&& config.get(EntityConfigType.PINKY).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.PINKY2016.get(), config.get(EntityConfigType.PINKY).SPAWN_WEIGHT,
					config.get(EntityConfigType.PINKY).MIN_GROUP, config.get(EntityConfigType.PINKY).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.TENTACLE, biome)
				&& config.get(EntityConfigType.TENTACLE).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.TENTACLE.get(), config.get(EntityConfigType.TENTACLE).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.WHIPLASH, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.WHIPLASH.get(), config.get(EntityConfigType.WHIPLASH).SPAWN_WEIGHT,
		...
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.SUMMONER, biome)
			...
			base.add(new SpawnerData(ModEntityTypes.SUMMONER.get(), config.get(EntityConfigType.SUMMONER).SPAWN_WEIGHT,
					config.get(EntityConfigType.SUMMONER).MIN_GROUP, config.get(EntityConfigType.SUMMONER).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.BARON, biome)
				&& config.get(EntityConfigType.BARON).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.BARON2016.get(), config.get(EntityConfigType.BARON).SPAWN_WEIGHT,
					config.get(EntityConfigType.BARON).MIN_GROUP, config.get(EntityConfigType.BARON).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.BARON, biome)
				&& config.get(EntityConfigType.BARON).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.FIREBARON.get(), config.get(EntityConfigType.BARON).SPAWN_WEIGHT,
					config.get(EntityConfigType.BARON).MIN_GROUP, config.get(EntityConfigType.BARON).MAX_GROUP));
		}
		if (BiomeEvaluator.parseListForBiomeCheck(BiomeConfig.BARON, biome)
				&& config.get(EntityConfigType.BARON).SPAWN_WEIGHT > 0) {
			base.add(new SpawnerData(ModEntityTypes.ARMORBARON.get(), config.get(EntityConfigType.BARON).SPAWN_WEIGHT,
					config.get(EntityConfigType.BARON).MIN_GROUP, config.get(EntityConfigType.BARON).MAX_GROUP));
		}
	}
}