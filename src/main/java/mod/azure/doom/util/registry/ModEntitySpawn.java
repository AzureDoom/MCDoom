...
public class ModEntitySpawn {
	...
	public static void onBiomesLoad(BiomeLoadingEvent event) {
		...
		if (parseBiomes(DoomConfig.SERVER.motherdemon_biomes.get(), event)) {
			base.add(new Spawners(ModEntityTypes.MOTHERDEMON.get(), DoomConfig.SERVER.motherdemon_spawn_weight.get(),
		...
		if (parseBiomes(DoomConfig.SERVER.maykrdrone_biomes.get(), event)) {
			base.add(new Spawners(ModEntityTypes.MAYKRDRONE.get(), DoomConfig.SERVER.maykrdrone_spawn_weight.get(),
		...
		if (parseBiomes(DoomConfig.SERVER.bloodmaykr_biomes.get(), event)) {
			base.add(new Spawners(ModEntityTypes.BLOODMAYKR.get(), DoomConfig.SERVER.bloodmaykr_spawn_weight.get(),
		...
		if (parseBiomes(DoomConfig.SERVER.archmaykr_biomes.get(), event)) {
			base.add(new Spawners(ModEntityTypes.ARCHMAKER.get(), DoomConfig.SERVER.archmaykr_spawn_weight.get(),
		...
		if (parseBiomes(DoomConfig.SERVER.gladiator_biomes.get(), event)) {
			base.add(new Spawners(ModEntityTypes.GLADIATOR.get(), DoomConfig.SERVER.gladiator_spawn_weight.get(),
