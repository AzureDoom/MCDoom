...
public class DoomStructures {
	...
	public static StructureFeature<StructurePoolFeatureConfig> ICON_FIGHT = new IconStructure(
			StructurePoolFeatureConfig.CODEC);
	public static StructureFeature<StructurePoolFeatureConfig> GLADIATOR_FIGHT = new GladiatorStructure(
			StructurePoolFeatureConfig.CODEC);
	...
	public static void setupAndRegisterStructureFeatures() {
		...
		FabricStructureBuilder.create(new Identifier(DoomMod.MODID, "icon_fight"), ICON_FIGHT)
				...
				.adjustsSurface().register();
		FabricStructureBuilder.create(new Identifier(DoomMod.MODID, "gladiator_fight"), GLADIATOR_FIGHT)
		.step(GenerationStep.Feature.SURFACE_STRUCTURES).defaultConfig(new StructureConfig(80, 20, 1234567892))
		.adjustsSurface().register();
	}
