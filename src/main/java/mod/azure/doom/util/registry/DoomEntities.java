...
public class DoomEntities {
	...
	public static final EntityType<BarrelEntity> BARREL = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ImpEntity> IMP = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<PinkyEntity> PINKY = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<LostSoulEntity> LOST_SOUL = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<LostSoulEntity> LOST_SOUL_ETERNAL = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "lost_soul_eternal"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, LostSoulEntity::new)
					.dimensions(EntityDimensions.fixed(1.5F, 1.5F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<CacodemonEntity> CACODEMON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ArchvileEntity> ARCHVILE = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<BaronEntity> BARON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<MancubusEntity> MANCUBUS = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<SpiderMastermindEntity> SPIDERMASTERMIND = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ArachnotronEntity> ARACHNOTRON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ZombiemanEntity> ZOMBIEMAN = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ImpStoneEntity> IMP_STONE = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "stone_imp"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ImpStoneEntity::new)
					.dimensions(EntityDimensions.fixed(0.6f, 1.95F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());
	public static final EntityType<ChaingunnerEntity> CHAINGUNNER = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "chaingunner"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ChaingunnerEntity::new)
					.dimensions(EntityDimensions.fixed(0.75f, 2.1F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<MarauderEntity> MARAUDER = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ShotgunguyEntity> SHOTGUNGUY = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "shotgunguy"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ShotgunguyEntity::new)
					.dimensions(EntityDimensions.fixed(0.75f, 2.1F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<PainEntity> PAIN = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "painelemental"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, PainEntity::new)
					.dimensions(EntityDimensions.fixed(2.0F, 2.0F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<HellknightEntity> HELLKNIGHT = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<Hellknight2016Entity> HELLKNIGHT2016 = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<Hellknight2016Entity> DREADKNIGHT = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "dreadknight"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, Hellknight2016Entity::new)
					.dimensions(EntityDimensions.fixed(1.8F, 3.0F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<CyberdemonEntity> CYBERDEMON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<UnwillingEntity> UNWILLING = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "unwilling"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, UnwillingEntity::new)
					.dimensions(EntityDimensions.fixed(0.6f, 1.95F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<PossessedSoldierEntity> POSSESSEDSOLDIER = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<PossessedScientistEntity> POSSESSEDSCIENTIST = Registry.register(
			Registries.ENTITY_TYPE, new Identifier(DoomMod.MODID, "possessed_scientist"),
	...
	public static final EntityType<PossessedScientistEntity> POSSESSEDWORKER = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "possessed_worker"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, PossessedScientistEntity::new)
					.dimensions(EntityDimensions.fixed(1.5f, 1.95F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<MechaZombieEntity> MECHAZOMBIE = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<CueBallEntity> CUEBALL = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<GoreNestEntity> GORE_NEST = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<GargoyleEntity> GARGOYLE = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "gargoyle"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, GargoyleEntity::new)
					.dimensions(EntityDimensions.fixed(3.0f, 4.0F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<ProwlerEntity> PROWLER = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "prowler"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ProwlerEntity::new)
					.dimensions(EntityDimensions.fixed(3.0f, 4.0F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<IconofsinEntity> ICONOFSIN = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ArachnotronEntity> ARACHNOTRONETERNAL = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<DoomHunterEntity> DOOMHUNTER = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<WhiplashEntity> WHIPLASH = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<BaronEntity> BARON2016 = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "baron2016"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, BaronEntity::new)
					.dimensions(EntityDimensions.fixed(1.7f, 4.2F)).fireImmune().trackedUpdateRate(1)
					.trackRangeBlocks(90).build());

	public static final EntityType<FireBaronEntity> FIREBARON = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "firebronebaron"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, FireBaronEntity::new)
					.dimensions(EntityDimensions.fixed(1.7f, 4.2F)).fireImmune().trackedUpdateRate(1)
					.trackRangeBlocks(90).build());

	public static final EntityType<ArmoredBaronEntity> ARMORBARON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<SpiderMastermind2016Entity> SPIDERMASTERMIND2016 = Registry.register(
			Registries.ENTITY_TYPE, new Identifier(DoomMod.MODID, "spidermastermind2016"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, SpiderMastermind2016Entity::new)
					.dimensions(EntityDimensions.fixed(6.0F, 4.0F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<MaykrDroneEntity> MAYKRDRONE = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<TentacleEntity> TENTACLE = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<MotherDemonEntity> MOTHERDEMON = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<BloodMaykrEntity> BLOODMAYKR = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<ArchMakyrEntity> ARCHMAKER = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<SummonerEntity> SUMMONER = Registry.register(Registries.ENTITY_TYPE,
	...
	public static final EntityType<Revenant2016Entity> REVENANT2016 = Registry.register(Registries.ENTITY_TYPE,
			new Identifier(DoomMod.MODID, "revenant2016"),
			FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, Revenant2016Entity::new)
					.dimensions(EntityDimensions.fixed(1.9f, 3.95F)).fireImmune().trackRangeBlocks(90)
					.trackedUpdateRate(1).forceTrackedVelocityUpdates(true).build());

	public static final EntityType<GladiatorEntity> GLADIATOR = Registry.register(Registries.ENTITY_TYPE,
