...
public class ServerEvents {
	...
	public static void anvilEvent(AnvilUpdateEvent event) {
		if (((event.getLeft().getItem() instanceof DoomBaseItem)
				...
				&& (EnchantmentHelper.getEnchantments(event.getRight()).containsKey(Enchantments.MENDING)
						|| EnchantmentHelper.getEnchantments(event.getRight()).containsKey(Enchantments.UNBREAKING)
						|| EnchantmentHelper.getEnchantments(event.getRight()).containsKey(Enchantments.INFINITY_ARROWS)
						|| EnchantmentHelper.getEnchantments(event.getRight()).containsKey(Enchantments.FLAMING_ARROWS)
						|| EnchantmentHelper.getEnchantments(event.getRight())
								.containsKey(Enchantments.PUNCH_ARROWS))) {
