...
public class DoomMod {
	...
	public void addCreativeTabs(final CreativeModeTabEvent.Register event) {
		event.registerCreativeModeTab(new ResourceLocation(MODID, "eggs"), e -> e.icon(() -> new ItemStack(DoomItems.IMP_SPAWN_EGG.get())).title(Component.translatable("itemGroup." + MODID + ".eggs")).displayItems((context, entries) -> {
		...
		event.registerCreativeModeTab(new ResourceLocation(MODID, "armor"), e -> e.icon(() -> new ItemStack(DoomItems.DOOM_HELMET.get())).title(Component.translatable("itemGroup." + MODID + ".armor")).displayItems((context, entries) -> {
		...
		event.registerCreativeModeTab(new ResourceLocation(MODID, "blocks"), e -> e.icon(() -> new ItemStack(DoomBlocks.BARREL_BLOCK.get())).title(Component.translatable("itemGroup." + MODID + ".blocks")).displayItems((context, entries) -> {
		...
		event.registerCreativeModeTab(new ResourceLocation(MODID, "weapons"), e -> e.icon(() -> new ItemStack(DoomItems.BFG_ETERNAL.get())).title(Component.translatable("itemGroup." + MODID + ".eggs")).displayItems((context, entries) -> {
		...
		event.registerCreativeModeTab(new ResourceLocation(MODID, "powerup"), e -> e.icon(() -> new ItemStack(DoomItems.SOULCUBE.get())).title(Component.translatable("itemGroup." + MODID + ".eggs")).displayItems((context, entries) -> {
