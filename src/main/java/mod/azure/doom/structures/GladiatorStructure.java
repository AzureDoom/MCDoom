...
public class GladiatorStructure extends Structure {
	...
	public static final Codec<GladiatorStructure> CODEC = RecordCodecBuilder
			.<GladiatorStructure>mapCodec(instance -> instance.group(GladiatorStructure.settingsCodec(instance),
	...
	protected GladiatorStructure(StructureSettings config, Holder<StructureTemplatePool> startPool,
	...
	public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
		...
		Optional<GenerationStub> structurePiecesGenerator = JigsawPlacement.addPieces(context, this.startPool,
				this.startJigsawName, this.size, blockpos, false, Optional.empty(), this.maxDistanceFromCenter);
