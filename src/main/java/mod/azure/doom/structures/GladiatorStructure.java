...
public class GladiatorStructure extends StructureFeature {
	...
	public GladiatorStructure(StructureFeature.StructureSettings config, Holder<StructurePool> startPool,
