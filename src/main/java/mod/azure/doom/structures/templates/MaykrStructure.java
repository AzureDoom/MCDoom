...
public class MaykrStructure extends StructureFeature<JigsawConfiguration> {

	public MaykrStructure(Codec<JigsawConfiguration> codec) {
		super(codec, (context) -> {
			if (!MaykrStructure.isFeatureChunk(context)) {
	...
	public static void setupStructureSpawns(final StructureSpawnListGatherEvent event) {
		if (event.getStructure() == DoomStructures.MAYKR.get()) {
