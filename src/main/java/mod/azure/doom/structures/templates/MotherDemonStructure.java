...
public class MotherDemonStructure extends StructureFeature<NoneFeatureConfiguration> {
	public MotherDemonStructure(Codec<NoneFeatureConfiguration> codec) {
		super(codec);
	}

	@Override
	public StructureFeature.StructureStartFactory<NoneFeatureConfiguration> getStartFactory() {
		return MotherDemonStructure.FeatureStart::new;
	}
		...
		if (structureConfig == null) {
			...
			for (int k = i - 10; k <= i + 10; ++k) {
				for (int l = j - 10; l <= j + 10; ++l) {
					ChunkPos chunkPos = DoomStructures.TITAN_SKULL.get().getPotentialFeatureChunk(structureConfig,
