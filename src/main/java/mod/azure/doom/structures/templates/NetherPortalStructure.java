...
public class NetherPortalStructure extends StructureFeature<JigsawConfiguration> {

	public NetherPortalStructure(Codec<JigsawConfiguration> codec) {
		super(codec, (context) -> {
			if (!NetherPortalStructure.isFeatureChunk(context)) {
	...
	public static void setupStructureSpawns(final StructureSpawnListGatherEvent event) {
		if (event.getStructure() == DoomStructures.NETHERPORTAL.get()) {
