...
public class MotherdemonStructure extends Structure {
	...
	public MotherdemonStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool, Optional<ResourceLocation> startJigsawName, int size, HeightProvider startHeight, Optional<Heightmap.Types> projectStartToHeightmap, int maxDistanceFromCenter) {
		super(config);
	...
	public StructureType<?> type() {
		return DoomStructures.MOTHERDEMON.get();
	}
}