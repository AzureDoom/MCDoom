...
public class MotherdemonStructure extends Structure {
	...
	public static final Codec<MotherdemonStructure> CODEC = RecordCodecBuilder.<MotherdemonStructure>mapCodec(
			instance -> instance.group(MotherdemonStructure.settingsCodec(instance),
	...
	public MotherdemonStructure(Structure.StructureSettings config, Holder<StructureTemplatePool> startPool,
