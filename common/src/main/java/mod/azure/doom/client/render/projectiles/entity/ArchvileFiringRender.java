...
public class ArchvileFiringRender extends GeoEntityRenderer<DoomFireEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DoomFireEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
