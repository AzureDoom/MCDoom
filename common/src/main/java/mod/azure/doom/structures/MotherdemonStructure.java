...
public class MotherdemonStructure extends Structure {
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        return JigsawPlacement.addPieces(context, startPool, startJigsawName, size, blockpos, false, projectStartToHeightmap, maxDistanceFromCenter);
    }
