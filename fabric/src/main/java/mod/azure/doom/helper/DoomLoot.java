...
public record DoomLoot() {
    ...
    public static final ResourceLocation BASTION_HOGLIN_STABLE = new ResourceLocation("minecraft",
    ...
    public static final ResourceLocation BASTION_TREASURE = new ResourceLocation("minecraft",
    ...
    public static final ResourceLocation SPAWN_BONUS_CHEST = new ResourceLocation("minecraft",
